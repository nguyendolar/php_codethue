	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-lg-10 order-md-last">
				<div class="row">
					<?php
					$product  =  getProductsWithImages();
					foreach ($product as $p) {
					?>
						<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
							<div class="product d-flex flex-column">
								<a href="product-single.php?id=<?= $p['product_id']?>" class="img-prod"><img class="img-fluid" src="Assets/<?= $p['image_source'] ?>" alt="">
				...
				<div class="sidebar">
					...
					<script>
						function sortProducts() {
							...
							var parentContainer = document.querySelector(".row .order-md-last .row");
							parentContainer.innerHTML = ""; // Xóa danh sách sản phẩm hiện tại
